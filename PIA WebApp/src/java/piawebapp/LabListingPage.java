 ...
 *
 * @version LabListingPage.java
 * @version Created on 23.09.2009., 23.06.51
 * @author Administrator
 */

public class LabListingPage extends AbstractPageBean {
    ...
    public void init() {
        ...
        try {
            ...
            log("LabListingPage Initialization Failure", e);
