            ...
            <webuijsf:html id="html1">
                ...
                <webuijsf:body id="body1" style="-rave-layout: grid">
                    ...
                    <webuijsf:form id="form1">
                        <h:outputText id="text1" value="Sala: #{manageUser.reservation.sala}" style="font-size: 20pt"/><br/>
                        <h:outputText id="text2" value="Namena rezervacije: #{manageUser.reservation.namena}" style="font-size: 20pt"/><br/>
